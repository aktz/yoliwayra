    ...
    <div id="page-container" class="sidebar-o sidebar-dark enable-page-overlay side-scroll page-header-fixed main-content-narrow">
                      ...
                      <tbody>
                        ...
                        <?php
                            foreach ($array as $item) {
                              $activo = $item["activo_estado"] == 1 ? "SI" : "NO";
                              echo '<tr>';
                                ...
                                echo '<td class="text-center">';
                                  echo '<div class="btn-group">';
                                    ...
                                    echo '</button>';
                                    echo '<button type="button" id="delete" onclick="DeleteClick(' . $item["id_estado"] . ')" class="btn btn-sm btn-alt-secondary" title="Eliminar">';
      ...
      <div class="modal" id="modal-update" tabindex="-1" role="dialog" aria-labelledby="modal-update" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
          <div class="modal-content">
            <div class="block block-rounded block-transparent mb-0">
              <form action="estados/update" method="POST">
                <div class="block-header block-header-default">
