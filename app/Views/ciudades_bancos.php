...
<html lang="en">
  ...
  <body>
    <div id="page-container" class="sidebar-o sidebar-dark enable-page-overlay side-scroll page-header-fixed main-content-narrow">
        ...
        <div class="modal-dialog modal-sm" role="document">
          <div class="modal-content">
            <div class="block block-rounded block-transparent mb-0">
              <form action="<?= base_url("/ciudades_bancos/insert"); ?>" method="POST">
      ...
      <div class="modal" id="modal-update" tabindex="-1" role="dialog" aria-labelledby="modal-update" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
          <div class="modal-content">
            <div class="block block-rounded block-transparent mb-0">
              <form action="<?= base_url("/ciudades_bancos/update"); ?>" method="POST">
                <div class="block-header block-header-default">
    ...
    <script>
      ...
      function UpdateClick(id, ciudad, nombre_ciudad, banco, descripcion, notas) {
        $("#hid-id-upd").val(id);
