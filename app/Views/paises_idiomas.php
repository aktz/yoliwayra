  ...
  <body>
    <div id="page-container" class="sidebar-o sidebar-dark enable-page-overlay side-scroll page-header-fixed main-content-narrow">
        ...
        <div class="modal-dialog modal-sm" role="document">
          <div class="modal-content">
            <div class="block block-rounded block-transparent mb-0">
              <form action="paises_idiomas/insert" method="POST">
                ...
                <div class="block-content fs-sm">
                  <div class="block-content block-content-full">
                    <div class="row">
                      ...
                      <div class="mb-4">
                        <label class="form-label" for="idioma-ins">Idioma</label>
                        <select class="form-select" id="idioma-ins" name="idioma-ins" size="5">
      ...
      <div class="modal" id="modal-update" tabindex="-1" role="dialog" aria-labelledby="modal-update" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
          <div class="modal-content">
            <div class="block block-rounded block-transparent mb-0">
              <form action="paises_idiomas/update" method="POST">
                <div class="block-header block-header-default">
                ...
                <div class="block-content fs-sm">
                  <div class="block-content block-content-full">
                    <div class="row">
                      ...
                      <div class="mb-4">
                        <label class="form-label" for="idioma-upd">País</label>
                        <select class="form-select" id="idioma-upd" name="pais-upd" size="5">
    ...
    <script>
      ...
      function DeleteItem(id) {
        $.ajax({
          url: '<?= base_url('/paises_idiomas/delete'); ?>',
          type: 'POST',
          data: { id: id },
          dataType: 'json'
        });
