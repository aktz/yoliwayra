  ...
  <body>
    <div id="page-container" class="sidebar-o sidebar-dark enable-page-overlay side-scroll page-header-fixed main-content-narrow">
        ...
        <div class="modal-dialog modal-sm" role="document">
          <div class="modal-content">
            <div class="block block-rounded block-transparent mb-0">
              <form action="perfiles/insert" method="POST">
                  ...
                  <div class="block-content block-content-full">
                    <div class="row">
                      ...
                      <div class="form-check form-block mb-4" style="padding: 0px 13px">
                        <input class="form-check-input" type="checkbox" value="" id="crear-ins" name="crear-ins" checked />
                        <label class="form-check-label" for="crear-ins">
                          <span class="d-flex align-items-center">
                            <span class="ms-2">
                              <input type="hidden" id="hidCrear-ins" name="hidCrear-ins" value="1" />
                              <span id="crearTitulo">Crear</span>
                            </span>
                          </span>
                        </label>
                      </div>
                      <div class="form-check form-block mb-4" style="padding: 0px 13px">
                        <input class="form-check-input" type="checkbox" value="" id="actualizar-ins" name="actualizar-ins" checked />
                        <label class="form-check-label" for="actualizar-ins">
                          <span class="d-flex align-items-center">
                            <span class="ms-2">
                              <input type="hidden" id="hidActualizar-ins" name="hidActualizar-ins" value="1" />
                              <span id="actualizarTitulo">Actualizar</span>
                            </span>
                          </span>
                        </label>
                      </div>
                      <div class="form-check form-block mb-4" style="padding: 0px 13px">
                        <input class="form-check-input" type="checkbox" value="" id="eliminar-ins" name="eliminar-ins" checked />
                        <label class="form-check-label" for="eliminar-ins">
                          <span class="d-flex align-items-center">
                            <span class="ms-2">
                              <input type="hidden" id="hidEliminar-ins" name="hidEliminar-ins" value="1" />
                              <span id="eliminarTitulo">Eliminar</span>
                            </span>
                          </span>
                        </label>
                      </div>
                      <div class="form-check form-block mb-4" style="padding: 0px 13px">
                        <input class="form-check-input" type="checkbox" value="" id="aprobar-ins" name="aprobar-ins" checked />
                        <label class="form-check-label" for="aprobar-ins">
                          <span class="d-flex align-items-center">
                            <span class="ms-2">
                              <input type="hidden" id="hidAprobar-ins" name="hidAprobar-ins" value="1" />
                              <span id="aprobarTitulo">Aprobar</span>
                            </span>
                          </span>
                        </label>
                      </div>
      ...
      <div class="modal" id="modal-update" tabindex="-1" role="dialog" aria-labelledby="modal-update" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
          <div class="modal-content">
            <div class="block block-rounded block-transparent mb-0">
              <form action="alimentaciones/update" method="POST">
                <div class="block-header block-header-default">
    ...
    <script>
      $(document).ready(function() {
        ...
        $('#crear-ins').on('click', function() {
          if( $(this).is(':checked') ){
            $("#crearTitulo").text("Activo");
            $("#hid-activo-ins").val("1");
            console.log("hidCrear: "  + $("#hidCrear-ins").val());
          } else {
            $("#crearTitulo").text("Inactivo");
            $("#hidCrear-ins").val("0");
            console.log("hidCrear: "  + $("#hidCrear-ins").val());
          }
        });
        $('#actualizar-ins').on('click', function() {
          if( $(this).is(':checked') ){
            $("#actualizarTitulo").text("Activo");
            $("#hidActualizar-ins").val("1");
            console.log("hid-activo: "  + $("#hidActualizar-ins").val());
          } else {
            $("#actualizarTitulo").text("Inactivo");
            $("#hidActualizar-ins").val("0");
            console.log("hidActualizar: "  + $("#hidActualizar-ins").val());
          }
        });
        $('#eliminar-ins').on('click', function() {
          if( $(this).is(':checked') ){
            $("#eliminarTitulo").text("Activo");
            $("#hidEliminar-ins").val("1");
            console.log("hid-activo: "  + $("#hidEliminar-ins").val());
          } else {
            $("#eliminarTitulo").text("Inactivo");
            $("#hidEliminar-ins").val("0");
            console.log("hidEliminar: "  + $("#hidEliminar-ins").val());
          }
        });
        $('#aprobar-ins').on('click', function() {
          if( $(this).is(':checked') ){
            $("#aprobarTitulo").text("Activo");
            $("#hidAprobar-ins").val("1");
            console.log("hidAprobar: "  + $("#hidAprobar-ins").val());
          } else {
            $("#aprobarTitulo").text("Inactivo");
            $("#hidAprobar-ins").val("0");
            console.log("hidAprobar: "  + $("#hidAprobar-ins").val());
          }
        });
