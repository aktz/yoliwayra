...
<html lang="en">
  <head>
    ...
    <title>Transportes de Ciudad</title>
  ...
  <body>
                      ...
                      <tbody>
                        ...
                        <?php
                            foreach ($array as $item) {
                              echo '<tr>';
                                echo '<td>' . $item["nombre_origen"] . '</td>';
                                echo '<td>' . $item["nombre_destino"] . '</td>';
                                echo '<td>' . $item["nombre_transporte"] . '</td>';
              ...
              <form action="ciudades_transportes/insert" method="POST">
                ...
                <div class="block-content fs-sm">
                  <div class="block-content block-content-full">
                    <div class="row">
                      <div class="mb-4">
                        <label class="form-label" for="origen-ins">Origen</label>
                        <select class="form-select" id="origen-ins" name="origen-ins" size="5">
                      ...
                      <div class="mb-4">
                        <label class="form-label" for="destino-ins">Destino</label>
                        <select class="form-select" id="destino-ins" name="destino-ins" size="5">
                      ...
                      <div class="mb-4">
                        <label class="form-label" for="transporte-ins">Terminal</label>
                        <select class="form-select" id="transporte-ins" name="transporte-ins" size="5">

                          <?php
                            foreach ($transportes as $transporte) {
                              echo '<option value="' . $transporte["id"] . '">' . $transporte["nombre"] . '</option>';
                            }
                          ?>
                ...
                <div class="block-content fs-sm">
                  <div class="block-content block-content-full">
                    <div class="row">
                      ...
                      <div class="mb-4">
                        <label class="form-label" for="origen-upd">Ciudad</label>
                        <select class="form-select" id="origen-upd" name="origen-upd" size="5">
                      ...
                      <div class="mb-4">
                        <label class="form-label" for="destino-upd">Ciudad</label>
                        <select class="form-select" id="destino-upd" name="destino-upd" size="5">
                      ...
                      <div class="mb-4">
                        <label class="form-label" for="transporte-upd">Terminal</label>
                        <select class="form-select" id="transporte-upd" name="transporte-upd" size="5">
    ...
    <script>
      ...
      function UpdateClick(id, origen, destino, transporte, descripcion, notas) {
        $("#hid-id-upd").val(id);
        $("#origen-upd").val(origen);
        $("#destino-upd").val(destino);
        $("#transporte-upd").val(transporte);
      ...
      function DeleteItem(id) {
        $.ajax({
          url: '<?= base_url('/ciudades_transportes/delete'); ?>',
          type: 'POST',
          data: { id: id },
          dataType: 'json'
        });
