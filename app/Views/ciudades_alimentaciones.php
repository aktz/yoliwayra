...
<html lang="en">
  <head>
    ...
    <title>Alimentaciones de Ciudad</title>
  ...
  <body>
    <div id="page-container" class="sidebar-o sidebar-dark enable-page-overlay side-scroll page-header-fixed main-content-narrow">
        ...
        <div class="modal-dialog modal-sm" role="document">
          <div class="modal-content">
            <div class="block block-rounded block-transparent mb-0">
              <form action="<?= base_url("/ciudades_alimentaciones/insert"); ?>" method="POST">
      ...
      <div class="modal" id="modal-update" tabindex="-1" role="dialog" aria-labelledby="modal-update" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
          <div class="modal-content">
            <div class="block block-rounded block-transparent mb-0">
              <form action="<?= base_url("/ciudades_alimentaciones/update"); ?>" method="POST">
                <div class="block-header block-header-default">
                ...
                <div class="block-content fs-sm">
                  <div class="block-content block-content-full">
                    <div class="row">
                      ...
                      <div class="mb-4">
                        <label class="form-label" for="alimentacion-upd">Alimentación</label>
    ...
    <script>
      ...
      function UpdateClick(id, ciudad, nombre_ciudad, alimentacion, descripcion, notas) {
        $("#hid-id-upd").val(id);
      ...
      function DeleteItem(id) {
        $.ajax({
          url: '<?= base_url('/ciudades_alimentaciones/delete'); ?>',
          type: 'POST',
          data: { id: id },
          dataType: 'json'
        });
