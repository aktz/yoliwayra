...
<html lang="en">
  <head>
    ...
    <title>Categorias del Lugar</title>
  ...
  <body>
    <div id="page-container" class="sidebar-o sidebar-dark enable-page-overlay side-scroll page-header-fixed main-content-narrow">
                        ...
                        <?php
                            foreach ($array as $item) {
                              echo '<tr>';
                                ...
                                echo '<td>' . $item["nombre_categoria"] . '</td>';
        ...
        <div class="modal-dialog modal-sm" role="document">
          <div class="modal-content">
            <div class="block block-rounded block-transparent mb-0">
              <form action="<?= base_url("/lugares_categorias/insert"); ?>" method="POST">
                ...
                <div class="block-content fs-sm">
                  <div class="block-content block-content-full">
                    <div class="row">
                      ...
                      <div class="mb-4">
                        <label class="form-label" for="categoria-ins">Categoria</label>
                        <select class="form-select" id="categoria-ins" name="categoria-ins" size="5">
      ...
      <div class="modal" id="modal-update" tabindex="-1" role="dialog" aria-labelledby="modal-update" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
          <div class="modal-content">
            <div class="block block-rounded block-transparent mb-0">
              <form action="<?= base_url("/lugares_categorias/update"); ?>" method="POST">
                <div class="block-header block-header-default">
                ...
                <div class="block-content fs-sm">
                  <div class="block-content block-content-full">
                    <div class="row">
                      ...
                      <input type="hidden" id="hid-id-categoria-upd" name="hid-id-categoria-upd" />
                      <div class="mb-4">
                      ...
                      <div class="mb-4">
                        <label class="form-label" for="categoria-upd">Categoria</label>
                        <textarea class="form-control" id="categoria-upd" name="categoria-upd" rows="3" readonly></textarea>
                      </div>                  
                      <div class="mb-4">
    ...
    <script>
      ...
      function UpdateClick(id, lugar, nombre_lugar, categoria, nombre_categoria, notas) {
        $("#hid-id-upd").val(id);
        $("#hid-id-lugar-upd").val(lugar);
        $("#hid-id-categoria-upd").val(categoria);
        $("#lugar-upd").val(nombre_lugar);
        $("#categoria-upd").val(nombre_categoria);
        $("#notas-upd").val(notas);
      }
      ...
      function DeleteItem(id) {
        $.ajax({
          url: '<?= base_url('/lugares_categorias/delete'); ?>',
          type: 'POST',
          data: { id: id },
          dataType: 'json'
        });
