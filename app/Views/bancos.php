...
<html lang="en">
  ...
  <body>
    <div id="page-container" class="sidebar-o sidebar-dark enable-page-overlay side-scroll page-header-fixed main-content-narrow">
                    ...
                    <table class="table table-bordered table-striped table-vcenter js-dataTable-responsive">
                      <thead>
                        <tr>
                          ...
                          <th class="text-center" style="width: 12%;">Cajero</th>
                          <th class="text-center" style="width: 12%;">Corresponsal</th>
                      ...
                      <tbody>
                        ...
                        <?php
                            foreach ($array as $item) {
                              ...
                              $oficina = $item["oficina"] == 1 ? "SI" : "NO";
                              $cajero = $item["cajero"] == 1 ? "SI" : "NO";
                              $corresponsal = $item["corresponsal"] == 1 ? "SI" : "NO";
                              $name = $item["nombre"];
                              echo '<tr>';
                                echo '<td>' . $item["nombre"] . '</td>';
                                echo '<td class="text-center">' . $oficina . '</td>';
                                echo '<td class="text-center">' . $cajero . '</td>';
                                echo '<td class="text-center">' . $corresponsal . '</td>';
        ...
        <div class="modal-dialog modal-sm" role="document">
          <div class="modal-content">
            <div class="block block-rounded block-transparent mb-0">
              <form action="bancos/insert" method="POST">
                  ...
                  <div class="block-content block-content-full">
                    <div class="row">
                      ...
                      <div class="form-check form-block mb-4" style="padding: 0px 13px">
                        <input class="form-check-input" type="checkbox" value="" id="oficina-ins" name="oficina-ins" checked />
                      ...
                      <div class="form-check form-block mb-4" style="padding: 0px 13px">
                        <input class="form-check-input" type="checkbox" value="" id="cajero-ins" name="cajero-ins" checked />
                      ...
                      <div class="form-check form-block mb-4" style="padding: 0px 13px">
                        <input class="form-check-input" type="checkbox" value="" id="corresponsal-ins" name="corresponsal-ins" checked />
      ...
      <div class="modal" id="modal-update" tabindex="-1" role="dialog" aria-labelledby="modal-update" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
          <div class="modal-content">
            <div class="block block-rounded block-transparent mb-0">
              <form action="bancos/update" method="POST">
                <div class="block-header block-header-default">
                ...
                <div class="block-content fs-sm">
                  <div class="block-content block-content-full">
                    <div class="row">
                      ...
                      <div class="form-check form-block mb-4" style="padding: 0px 13px">
                        <input class="form-check-input" type="checkbox" value="" id="oficina-upd" name="oficina-upd" checked />
                      ...
                      <div class="form-check form-block mb-4" style="padding: 0px 13px">
                        <input class="form-check-input" type="checkbox" value="" id="cajero-upd" name="cajero-upd" checked />
                      ...
                      <div class="form-check form-block mb-4" style="padding: 0px 13px">
                        <input class="form-check-input" type="checkbox" value="" id="corresponsal-upd" name="corresponsal-upd" checked />
    ...
    <script>
      ...
      function UpdateClick(id, nombre, oficina, cajero, corresponsal, activo) {
        $("#hid-id-upd").val(id);
        $("#nombre-upd").val(nombre);
        $("#oficina-upd").prop("checked", oficina == 1 ? true : false);
        $("#cajero-upd").prop("checked", cajero == 1 ? true : false);
        $("#corresponsal-upd").prop("checked", corresponsal == 1 ? true : false);
        $("#activo-upd").prop("checked", activo == 1 ? true : false);
        $("#hid-oficina-upd").val(oficina);
        $("#hid-cajero-upd").val(cajero);
        $("#hid-corresponsal-upd").val(corresponsal);
