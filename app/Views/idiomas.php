...
<html lang="en">
  ...
  <body>
    <div id="page-container" class="sidebar-o sidebar-dark enable-page-overlay side-scroll page-header-fixed main-content-narrow">
        ...
        <div class="modal-dialog modal-sm" role="document">
          <div class="modal-content">
            <div class="block block-rounded block-transparent mb-0">
              <form action="idiomas/insert" method="POST">
                ...
                <div class="block-content fs-sm">
                  <div class="block-content block-content-full">
                    <div class="row">
                      <div class="mb-4">
                        <label class="form-label" for="codigo-ins">Código</label>
                        <input type="text" class="form-control" id="codigo-ins" name="codigo-ins" />
                      </div>
                      <div class="mb-4">
      ...
      <div class="modal" id="modal-update" tabindex="-1" role="dialog" aria-labelledby="modal-update" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
          <div class="modal-content">
            <div class="block block-rounded block-transparent mb-0">
              <form action="idiomas/update" method="POST">
                <div class="block-header block-header-default">
                ...
                <div class="block-content fs-sm">
                  <div class="block-content block-content-full">
                    <div class="row">
                      ...
                      <div class="mb-4">
                        <label class="form-label" for="codigo-upd">Código</label>
                        <input type="text" class="form-control" id="codigo-upd" name="codigo-upd" />
                      </div>
                      <div class="mb-4">
    ...
    <script>
      $(document).ready(function() {
        ...
        $('#activo-ins').on('click', function() {
          if( $(this).is(':checked') ){
            ...
            console.log("hid-activo: "  + $("#hid-activo").val());
          } else {
      ...
      function UpdateClick(id, codigo, nombre, activo) {
        $("#hid-id-upd").val(id);
        $("#codigo-upd").val(codigo);
