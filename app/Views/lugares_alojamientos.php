...
<html lang="en">
  <head>
    ...
    <title>Alojamientos del Lugar</title>
  ...
  <body>
    <div id="page-container" class="sidebar-o sidebar-dark enable-page-overlay side-scroll page-header-fixed main-content-narrow">
        ...
        <div class="modal-dialog modal-sm" role="document">
          <div class="modal-content">
            <div class="block block-rounded block-transparent mb-0">
              <form action="<?= base_url("/lugares_alojamientos/insert"); ?>" method="POST">
      ...
      <div class="modal" id="modal-update" tabindex="-1" role="dialog" aria-labelledby="modal-update" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
          <div class="modal-content">
            <div class="block block-rounded block-transparent mb-0">
              <form action="<?= base_url("/lugares_alojamientos/update"); ?>" method="POST">
                <div class="block-header block-header-default">
                ...
                <div class="block-content fs-sm">
                  <div class="block-content block-content-full">
                    <div class="row">
                      ...
                      <input type="hidden" id="hid-id-alojamiento-upd" name="hid-id-alojamiento-upd" />
                      <div class="mb-4">
                      ...
                      <div class="mb-4">
                        <label class="form-label" for="alojamiento-upd">Alojamiento</label>
                        <textarea class="form-control" id="alojamiento-upd" name="alojamiento-upd" rows="3" readonly></textarea>
                      </div> 
                      <div class="mb-4">
    ...
    <script>
      ...
      function UpdateClick(id, lugar, nombre_lugar, alojamiento, nombre_alojamiento, descripcion, notas) {
        $("#hid-id-upd").val(id);
        $("#hid-id-lugar-upd").val(lugar);
        $("#hid-id-alojamiento-upd").val(alojamiento);
        $("#lugar-upd").val(nombre_lugar);
        $("#alojamiento-upd").val(nombre_alojamiento);
      ...
      function DeleteItem(id) {
        $.ajax({
          url: '<?= base_url('/lugares_alojamientos/delete'); ?>',
          type: 'POST',
          data: { id: id },
          dataType: 'json'
        });
