...
<html lang="en">
  <head>
    ...
    <title>Transportes del Lugar</title>
  ...
  <body>
    <div id="page-container" class="sidebar-o sidebar-dark enable-page-overlay side-scroll page-header-fixed main-content-narrow">
        ...
        <div class="modal-dialog modal-sm" role="document">
          <div class="modal-content">
            <div class="block block-rounded block-transparent mb-0">
              <form action="<?= base_url("/lugares_transportes/insert"); ?>" method="POST">
                ...
                <div class="block-content fs-sm">
                  <div class="block-content block-content-full">
                    <div class="row">
                      ...
                      <div class="mb-4">
                        <label class="form-label" for="transporte-ins">Transporte</label>
      ...
      <div class="modal" id="modal-update" tabindex="-1" role="dialog" aria-labelledby="modal-update" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
          <div class="modal-content">
            <div class="block block-rounded block-transparent mb-0">
              <form action="<?= base_url("/lugares_transportes/update"); ?>" method="POST">
                <div class="block-header block-header-default">
                ...
                <div class="block-content fs-sm">
                  <div class="block-content block-content-full">
                    <div class="row">
                      ...
                      <input type="hidden" id="hid-id-transporte-upd" name="hid-id-transporte-upd" />
                      <div class="mb-4">
                      ...
                      <div class="mb-4">
                        <label class="form-label" for="transporte-upd">Transporte</label>
                        <textarea class="form-control" id="transporte-upd" name="transporte-upd" rows="3" readonly></textarea>
                      </div> 
                      <div class="mb-4">
    ...
    <script>
      ...
      function UpdateClick(id, lugar, nombre_lugar, transporte, nombre_transporte, descripcion, notas) {
        $("#hid-id-upd").val(id);
        $("#hid-id-lugar-upd").val(lugar);
        $("#hid-id-transporte-upd").val(transporte);
        $("#lugar-upd").val(nombre_lugar);
        $("#transporte-upd").val(nombre_transporte);
      ...
      function DeleteItem(id) {
        $.ajax({
          url: '<?= base_url('/lugares_transportes/delete'); ?>',
          type: 'POST',
          data: { id: id },
          dataType: 'json'
        });
