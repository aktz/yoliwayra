...
use App\Models\LugarAlojamientoModel;
use App\Models\LugarCategoriaModel;
use App\Models\LugarEventoModel;
use App\Models\LugarGuianzaModel;
use App\Models\LugarTransporteModel;
...
abstract class BaseController extends Controller
{
    ...
    public function initController(RequestInterface $request, ResponseInterface $response, LoggerInterface $logger)
    {
        ...
        $this->lugar_alojamiento = new LugarAlojamientoModel();
        $this->lugar_categoria = new LugarCategoriaModel();
        $this->lugar_evento = new LugarEventoModel();
        $this->lugar_guianza = new LugarGuianzaModel();
        $this->lugar_transporte = new LugarTransporteModel();
